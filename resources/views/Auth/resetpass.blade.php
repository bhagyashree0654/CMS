            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->                    
                        <form class="md-float-material form-material" action="resetpass" method="POST" onsubmit="return validatePass()">
                            @csrf
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <span class="text-success">{{$otpverifymsg ?? ''}}</span>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="pass" id="pass" class="form-control" placeholder="Enter Password" autocomplete="off">
                                        <span id="passerr" class="text-danger"></span>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="cpass" id="cpass" class="form-control" placeholder="Enter confirm Password" autocomplete="off">
