        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" action="validateOTP" method="POST" onsubmit="return chkotp()">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <span class="text-success">{{$otpmsg}} <i class="fa fa-arrow-right"></i>" {{session('foundId')}} "</span>
                                </div>
                                <div class="form-group form-primary">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Validate</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
...
<!-- Required Jquery -->
    <script type="text/javascript" src="public/assets/assets/js/jquery/jquery.min.js"></script>     <script type="text/javascript" src="public/assets/assets/js/jquery-ui/jquery-ui.min.js "></script>     <script type="text/javascript" src="public/assets/assets/js/popper.js/popper.min.js"></script>     <script type="text/javascript" src="public/assets/assets/js/bootstrap/js/bootstrap.min.js "></script>
<!-- waves js -->
...
<!-- modernizr js -->
<script type="text/javascript" src="public/assets/assets/js/SmoothScroll.js"></script>     <script src="public/assets/assets/js/jquery.mCustomScrollbar.concat.min.js "></script>
...
<script>
     function chkotp(){
                ...
                if(otp == ""){
                    document.getElementById('otperr').innerHTML = "Please Enter the OTP";    
                    return false;
                }
                if(otp.length < 6){
