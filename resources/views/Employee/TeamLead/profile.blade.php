      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  method="post" action="updateEmployeeInfoManual" id="updateEmpInfo" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <textarea name="address" id="address" class="form-control" cols="40" rows="5" placeholder="update address here.."></textarea>
            </div>
...
@push('scripts')
<script src="resources\views\js\teamlead.js"></script>
<script>
